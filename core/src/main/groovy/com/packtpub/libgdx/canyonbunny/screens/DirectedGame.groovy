...
@TypeChecked
abstract class DirectedGame implements ApplicationListener {
    ...
    public void setScreen(AbstractGameScreen screen, ScreenTransition screenTransition = null) {
        int w = Gdx.graphics.width
        int h = Gdx.graphics.height

        if (!init) {
            currFbo = new FrameBuffer(RGB888, w, h, false)
            nextFbo = new FrameBuffer(RGB888, w, h, false)
    ...
    public void render() {
        ...
        if (nextScreen == null) {
            ...
            if (screenTransition == null || t >= duration) {
                ...
                float alpha = (t / duration) as float
