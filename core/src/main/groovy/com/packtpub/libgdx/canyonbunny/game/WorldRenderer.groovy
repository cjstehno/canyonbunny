...
class WorldRenderer implements Disposable {
    ...
    private void renderGuiScore(SpriteBatch batch) {
        ...
        batch.draw(Assets.instance.goldCoin.goldCoin, offX, offY, 50, 50, 100, 100, 0.35f, -0.35f, 0)

        Assets.instance.fonts.defaultBig.draw(batch, worldController.score as String, (offX + 75) as float, (offY + 37) as float)
    }
